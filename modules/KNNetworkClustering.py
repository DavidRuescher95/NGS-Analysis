...
class KNNetwork:
    ...
    def pValFilter(self,thrsh=0.001):
        ...
        return self
    def networkGeneration(self,filterType=["pValue","depth"],nNeighbors=5,metric="correlation",
        ...
        return self
    def louvain(self,minClusterSize=50, minClusterDegree = 1, resolution=1):
        '''
        ...
        for index, cluster in enumerate(clusters):
            ...
            removeCommunity = [node for node,degree in dict(g.degree()).items() if (degree) < minClusterDegree]
